...
search.addEventListener('click', () =>{
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?id=524901&units=metric&lang=pl&appid=${APIKey}`)
    ...
    .then(json => {
        if (json.cod === '404') {
            ...
            weaterDetails.style.display = '';
            weaterBox.classList.add('fadeIn');
            weaterDetails.classList.add('fadeIn');
